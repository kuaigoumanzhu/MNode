...
{
    /// <summary>
    /// Represents a provider to provide the message handlers.
    /// </summary>
    public interface IMessageHandlerProvider
    {
        /// <summary>
        /// Get all the handlers for the given message type.
        /// </summary>
    ...
    /// <summary>
    /// Represents a provider to provide the handlers which handle two messages.
    /// </summary>
    public interface ITwoMessageHandlerProvider
    {
        /// <summary>
        /// Get all the handlers for the given message types.
        /// </summary>
    ...
    /// <summary>
    /// Represents a provider to provide the handlers which handle three message.
    /// </summary>
